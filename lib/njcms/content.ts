 ...
 */
export function getSection<C extends StaticPropsType>(contentType: C, locale: string): Section {
...
const getContentDirectory = <C extends StaticPropsType>(contentType: C, locale: string): string => {
...
function getContentIndex<C extends StaticPropsType>(contentType: C, locale: string) {
 ...
 * @param locale translation id
 */
function getSortedContentData<C extends StaticPropsType>(contentType: C, locale: string): RenderedDocument[] {
    const contentDirectory = getContentDirectory(contentType, locale)
    const fileNames = walkDirectory(contentDirectory);
...
function getContentIds<C extends StaticPropsType>(contentType: C, locale: string) {
    const contentDirectory = getContentDirectory(contentType, locale)
    const fileNames = walkDirectory(contentDirectory);
